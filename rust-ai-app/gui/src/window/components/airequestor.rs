...
impl AIRequestor {
    pub async fn send_ai_prompt_request(prompt : &str, image_count : i32, width : i32, height : i32, inpaint_image_filepath:&str) -> Result<String, Error> {
        ...
        let url = format!("http://localhost:6969//pic2pic?prompt={}&img_count={}&width={}&height={}&filepath={}", prompt_encoded_string, image_count,width,height, filepath_encoded_string);
